  ...
  return (
    <div className="bg-white w-full mx-auto relative">
      ...
      <section className="relative h-[375px] bg-white overflow-hidden" style={{ height: '475px' }}>
        ...
        <div className="absolute right-[-80px] top-[-80px] w-[300px] h-[300px] bg-[#FFE5DC] rounded-full opacity-50 " style={{ zIndex: -1 }} />
        ...
        {/* Hero Title */}
        <div className="absolute left-1/2 top-[190px] transform -translate-x-1/2 -translate-y-1/2 text-center w-full max-w-[900px] px-8" style={{ marginTop: '40px' }}>
          <motion.h1
            className="font-['Kaushan_Script:Regular',sans-serif] text-[#101828] mb-3"
            style={{ fontSize: '64px' }}
          ...
          <motion.p
            className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[28px] text-center max-w-[700px] mx-auto"
            style={{ fontSize: '20px' }}
            initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-[960px] mx-auto">
          <div className="grid grid-cols-[1fr_auto] gap-12 items-start">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-['Momo_Trust_Display:Regular',sans-serif] text-[#101828] mb-5 leading-[48px]" style={{ fontSize: '48px' }}>
                The Artist Behind<br />the Vision
              </h2>
              <p className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[26px] mb-4" style={{ fontSize: '18px' }}>
              ...
              <p className="font-['Montserrat:SemiBold',sans-serif] text-[#FF8559] leading-[26px] italic" style={{ fontSize: '22px' }}>
      ...
      <section className="relative py-16 px-[60px] bg-white">
        <div className="max-w-[960px] mx-auto">
          <motion.h2
            className="font-['Momo_Trust_Display:Regular',sans-serif] text-[#101828] text-center mb-8"
            style={{ fontSize: '48px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          ...
          <motion.p
            className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[28px] text-center mb-10 max-w-[750px] mx-auto"
            style={{ fontSize: '20px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-2 gap-5 max-w-[850px] mx-auto">
            {[
              ...
              >
                ...
                <p className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[22px] pt-1" style={{ fontSize: '18px' }}>
                  {item.text}
                </p>
              </motion.div>
            ))}
      ...
      <section className="relative py-16 px-[60px] bg-gradient-to-b from-white to-[#FFF5F0]">
        <div className="max-w-[960px] mx-auto" style={{ maxWidth: '1400px' }}>
          <motion.h2
            className="font-['Momo_Trust_Display:Regular',sans-serif] text-[#101828] text-center mb-8"
            style={{ fontSize: '48px' }}
            initial={{ opacity: 0, y: 20 }}
          ...
          <motion.p
            className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[28px] text-center mb-12 max-w-[750px] mx-auto"
            style={{ fontSize: '20px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <h3 className="font-['Montserrat:SemiBold',sans-serif] text-[#101828] mb-1" style={{ fontSize: '20px' }}>
                  {item.title}
                </h3>
                <p className="font-['Montserrat:Regular',sans-serif] text-[#4a5565]" style={{ fontSize: '16px' }}>
                  {item.desc}
                </p>
              </motion.div>
            ))}
          ...
          >
            <div className="relative z-10">
              <p className="font-['Montserrat:SemiBold',sans-serif] text-white mb-1.5" style={{ fontSize: '24px' }}>
                Plus: Community Art Events & Exhibitions! 🌟
              </p>
              <p className="font-['Montserrat:Regular',sans-serif] text-white/90" style={{ fontSize: '18px' }}>
      ...
      <section className="relative py-16 px-[60px] bg-[#101828]">
        <div className="max-w-[800px] mx-auto text-center">
          <motion.h2
            className="font-['Kaushan_Script:Regular',sans-serif] text-white mb-6"
            style={{ fontSize: '52px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          ...
          <motion.p
            className="font-['Montserrat:Regular',sans-serif] text-white/80 leading-[28px] mb-8"
            style={{ fontSize: '20px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
          ...
          <motion.p
            className="font-['Montserrat:SemiBold',sans-serif] text-[#FF8559] leading-[28px]"
            style={{ fontSize: '24px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="relative py-16 px-[60px] bg-gradient-to-b from-[#FFF5F0] to-white">
        <div className="max-w-[650px] mx-auto text-center">
          <motion.h2
            className="font-['Kaushan_Script:Regular',sans-serif] text-[#101828] mb-5"
            style={{ fontSize: '48px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          ...
          <motion.p
            className="font-['Montserrat:Regular',sans-serif] text-[#4a5565] leading-[26px] mb-8"
            style={{ fontSize: '20px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
          ...
          <motion.button
            className="bg-[#FF8559] text-white px-10 py-4 rounded-full font-['Inter:Medium',sans-serif] cursor-pointer shadow-lg"
            style={{ fontSize: '18px' }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
