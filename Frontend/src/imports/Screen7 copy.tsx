...
import imgColorPaste1 from "figma:asset/7ef737858158740c7668b3bfd6718af5b64c6ac2.png";
import imgBrush11 from "figma:asset/951f8147cee9398be97469e9c7f57d14b18311a3.png";
import imgColorPallete1 from "figma:asset/bd75ab4031492a9dbf5f5f9f961ba86f94605bc0.png";
import imgPencil11 from "figma:asset/96bf2ac2cdecbd404d325d46ce5df6bbf262e6cc.png";
...
import imgWatercolor21 from "figma:asset/876f81c1ade73791dac6d0607f940fdb12c610f4.png";
import imgWatercolor31 from "figma:asset/a3e0e39734fda71632e1abf04660194cdb187719.png";
import imgWatercolor11 from "figma:asset/2e6b656e04f02b1ed5c43159572a0a4bdd11696b.png";
import imgWatercolor41 from "figma:asset/2bea4df35705dff62694beee53cf7b8de7446998.png";
...
import imgPencil31 from "figma:asset/55592a5420f1e1c12f1554cc488c4aaee992209b.png";
import imgPencil21 from "figma:asset/98cc252e848c4e25bb4692c9468a2259db7d7326.png";
import imgScissor1 from "figma:asset/efb7b28a6b0dc0d9d4273e8b7eecd2ef648728cc.png";
import imgEraser1 from "figma:asset/5e9f9c44a240bb7856e62a143746ffd6dead3e7c.png";
...
import imgClayArt41 from "figma:asset/d63be84fa3c35a1422ec3285be2cb255b937e76b.png";
import imgClayArt11 from "figma:asset/599b7bb3fc68fae394ec8e80a3489bbf91290bd0.png";
import imgClayArt31 from "figma:asset/8cdfdf8892c533743965f84307507be3264da96f.png";
import imgClayArt21 from "figma:asset/695f13139f59760a4421c39a25ee0b2bd0c8709f.png";
import imgSculptureClay1 from "figma:asset/f1fe0f33cab19244fc8833f7a6bf84a4a5b1b05a.png";
import imgMixedMedia41 from "figma:asset/40b7999bef371584f7719cbe02be53425166815a.png";
import imgMixedMedia21 from "figma:asset/a668eb493e9aceab3a1bb29b5022a22213e37224.png";
import imgMixedMedia11 from "figma:asset/70576982dd9babfbf06367572a9e37c2c90ba420.png";
import imgMixedMedia31 from "figma:asset/aa1c33090e1ee9e48dfd1f54b1cccba628394053.png";
import imgMixedMediaArts1 from "figma:asset/4b2b1f40487cff4e30658199b781ef1e5c59d605.png";
import imgCreativeCrafts4 from "figma:asset/07a7808e4c2346c0936db4a40234109414f945a7.png";
import imgCreativeCrafts2 from "figma:asset/4e25b9d3ebcebaee05e953505d3e630a53acc331.png";
import imgCreativeCrafts3 from "figma:asset/5a1b439eabccf937dee8bf124255d5f78b1dbe88.png";
import imgCreativeCrafts11 from "figma:asset/e114ac1ce3a557e8d2bec98a95c9ad5be61e5cb5.png";
...
function Icon() {
  return (
    <div
      className="absolute left-0 size-[16px] top-[2px]"
      data-name="Icon"
    >
      <svg
...
function Container1() {
  return (
    <div
      className="h-[20px] relative shrink-0 w-[131.125px]"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[131.125px]">
        <Icon />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[24px] not-italic text-[#6a7282] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">
          8-week program
        </p>
      </div>
    </div>
...
function Container2() {
  return (
    <div
      className="h-[20px] relative shrink-0 w-[94.906px]"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[94.906px]">
        <Icon1 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[24px] not-italic text-[#6a7282] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">
          $120-$180
        </p>
...
function Paragraph() {
  return (
    <div
      ...
      data-name="Paragraph"
    >
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] top-0 tracking-[-0.3125px] w-[365px]">
...
function Button() {
  return (
    <div
      className="absolute bg-[#f30d11] h-[48px] left-[12px] rounded-[1.67772e+07px] top-[129px] w-[131px]"
      data-name="Button"
    >
...
function PaintingEssentials() {
  return (
    <motion.div
      className="absolute h-[472px] left-[144px] overflow-clip top-[227px] w-[551px]"
    ...
    >
        ...
        style={
          {
            ...
            "--transform-inner-height": "109.515625",
      ...
      >
        <div className="flex-none rotate-[345.168deg]">
          <motion.div
            className="relative"
            data-name="color paste 1"
            variants={{
              normal: { height: 1.095, width: 1 },
              hover: { height: 109.519, width: 100 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
...
function Paragraph2() {
  return (
    <div
      ...
      data-name="Paragraph"
    >
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] top-0 tracking-[-0.3125px] w-[371px]">
...
function CreativeDrawing() {
  return (
    <motion.div
      className="absolute h-[472px] left-[573px] overflow-clip top-[238px] w-[551px]"
    ...
    >
      ...
      <motion.div
        ...
        variants={{
          ...
          hover: { width: 69, height: 71, left: 408, top: 4 },
        }}
        style={
          {
            "--transform-inner-width": "69",
            "--transform-inner-height": "71",
          } as React.CSSProperties
        }
        transition={{
          duration: 0.5,
      ...
      >
        <div className="flex-none rotate-[47.06deg]">
          <motion.div
            className="relative"
            data-name="Pencil 3 1"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 69, height: 71 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
      ...
      <motion.div
        ...
        variants={{
          ...
          hover: { width: 69, height: 71, left: 33, top: 233 },
        }}
        style={
          {
            "--transform-inner-width": "69",
      ...
      >
        <div className="flex-none rotate-[345.293deg]">
          <motion.div
            className="relative"
            data-name="pencil 2 1"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 69, height: 71 },
            }}
      ...
      <motion.div
        ...
        variants={{
          ...
          hover: { width: 90, height: 76, left: 400, top: 229 },
        }}
        style={
          {
            "--transform-inner-width": "90",
            "--transform-inner-height": "76",
          } as React.CSSProperties
        }
        transition={{
          duration: 0.5,
      ...
      >
        <div className="flex-none rotate-[186.333deg]">
          <motion.div
            className="relative"
            data-name="scissor 1"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 90, height: 76 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
      ...
      <motion.div
        ...
        data-name="Eraser 1"
        variants={{
          normal: { width: 0, height: 0, left: 270, top: 166 },
          hover: { width: 59, height: 49, left: 32, top: 5 },
        }}
        transition={{
          duration: 0.5,
          ease: [0.34, 1.56, 0.64, 1],
...
function Button2() {
  return (
    <div
      className="absolute bg-[#f30d11] h-[48px] left-[1141px] rounded-[1.67772e+07px] top-[640px] w-[131px]"
      data-name="Button"
    >
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[57.5px] not-italic text-[16px] text-center text-nowrap text-white top-[12px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre">{`Explore `}</p>
      <Icon8 />
...
function Button3() {
  return (
    <div
      className="absolute bg-[#f30d11] h-[48px] left-0 rounded-[1.67772e+07px] top-0 w-[131px]"
      data-name="Button"
    >
...
function Button4() {
  return (
    <div
      className="absolute bg-[#f30d11] h-[48px] left-[1143px] rounded-[1.67772e+07px] top-[1095px] w-[131px]"
      data-name="Button"
    >
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[57.5px] not-italic text-[16px] text-center text-nowrap text-white top-[12px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre">{`Explore `}</p>
      <Icon9 />
...
function SculptureClay() {
  return (
    <motion.div
      className="absolute h-[472px] left-[1050px] overflow-clip top-[227px] w-[551px]"
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={
            {
              "--transform-inner-width": "101",
              "--transform-inner-height": "103",
            } as React.CSSProperties
          }
          transition={{
            duration: 0.5,
        ...
        <motion.div
          ...
          style={
            {
              "--transform-inner-width": "116",
              "--transform-inner-height": "84",
            } as React.CSSProperties
          }
          transition={{
            duration: 0.5,
...
function WatercolorMagic1() {
  return (
    <motion.div
      className="absolute h-[482px] left-[589px] overflow-clip top-[671px] w-[591px]"
      data-name="Watercolor Magic"
      initial="normal"
      whileHover="hover"
    >
      ...
      >
        ...
        <motion.div
          ...
          style={
            {
              "--transform-inner-width": "106",
              "--transform-inner-height": "96",
            } as React.CSSProperties
          }
          transition={{
            duration: 0.5,
        ...
        <motion.div
          ...
          style={
            {
              "--transform-inner-width": "110",
              "--transform-inner-height": "94",
            } as React.CSSProperties
          }
          transition={{
            duration: 0.5,
...
function WatercolorMagic2() {
  return (
    <motion.div
      className="absolute h-[483px] left-[1047px] overflow-clip top-[684px] w-[591px]"
      data-name="Watercolor Magic"
      initial="normal"
      whileHover="hover"
    >
      ...
      {/* Creative crafts 4 - bottom right */}
      <motion.div
        className="absolute flex items-center justify-center"
        variants={{
          normal: {
      ...
      >
        <div className="flex-none rotate-[255.728deg]">
          <motion.div
            className="relative"
            data-name="creative crafts 4"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 97, height: 100 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
          ...
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgCreativeCrafts4}
            />
          </motion.div>
        </div>
      </motion.div>

      {/* Creative crafts 2 - top right */}
      <motion.div
        className="absolute flex items-center justify-center"
        variants={{
          normal: {
          ...
          hover: { width: 94, height: 100, left: 302, top: 1 },
        }}
        style={
          {
            "--transform-inner-width": "94",
            "--transform-inner-height": "100",
          } as React.CSSProperties
        }
        transition={{
      ...
      >
        <div className="flex-none rotate-[26.882deg]">
          <motion.div
            className="relative"
            data-name="creative crafts 2"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 94, height: 100 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
          ...
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgCreativeCrafts2}
            />
          </motion.div>
        </div>
      </motion.div>

      {/* Creative crafts 3 - bottom left */}
      <motion.div
        className="absolute flex items-center justify-center"
        variants={{
          normal: {
          ...
          hover: { width: 95, height: 99, left: 83, top: 234 },
        }}
        style={
          {
            "--transform-inner-width": "95",
            "--transform-inner-height": "99",
          } as React.CSSProperties
        }
        transition={{
          duration: 0.5,
      ...
      >
        <div className="flex-none rotate-[233.927deg]">
          <motion.div
            className="relative"
            data-name="creative crafts 3"
            variants={{
              normal: { width: 0, height: 0 },
              hover: { width: 95, height: 99 },
            }}
            transition={{
              duration: 0.5,
              ease: [0.34, 1.56, 0.64, 1],
          ...
          >
            <img
              alt=""
              className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
              src={imgCreativeCrafts3}
            />
          </motion.div>
        </div>
      </motion.div>

      {/* Creative crafts 1 1 - top left */}
      <motion.div
        className="absolute"
        data-name="creative crafts 1 1"
        variants={{
          normal: { width: 0, height: 0, left: 277, top: 178 },
          hover: { width: 82, height: 103, left: 92, top: 0 },
        }}
        transition={{
          duration: 0.5,
          ease: [0.34, 1.56, 0.64, 1],
...
function FeaturedArtPrograms() {
  return (
    <div
      className="absolute bg-[#edf6ff] h-[1364px] left-0 overflow-clip top-[-7px] w-[1728px]"
    ...
    >
      ...
      <Button9 />
      <Button10 />
      <p className="absolute font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[127px] left-[calc(50%+206px)] text-[64px] text-black text-center text-nowrap top-[75px] translate-x-[-50%] whitespace-pre">{`Art Programs `}</p>
      <p className="absolute font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[127px] left-[calc(50%-199.5px)] text-[64px] text-black text-center text-nowrap top-[75px] translate-x-[-50%] whitespace-pre">{`Featured `}</p>
    </div>
  );
}
