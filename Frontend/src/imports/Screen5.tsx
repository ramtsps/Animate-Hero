  ...
  return (
    <div className="absolute contents font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[105px] left-[317px] text-[#212224] text-[64px] text-center text-nowrap top-[415px] tracking-[-3px] whitespace-pre">
      ...
      <motion.p
        ...
        style={{ opacity: line1Opacity, x: line1X, letterSpacing: "0px !important" }}
      >
        Then let your
      </motion.p>
      <motion.p
        className="absolute  top-[414px] translate-x-[-50%]"
        style={{ opacity: line1Opacity, x: line1X, letterSpacing: "0px !important", left: "1165.5px" }}
      >
        {`child's creativity `}
      </motion.p>
      ...
      <motion.p
        ...
        style={{ opacity: line2Opacity, x: line2X, letterSpacing: "0px !important" }}
      >
        grow
      </motion.p>
      <motion.p
        className="absolute  top-[519px] translate-x-[-50%]"
        style={{ opacity: line2Opacity, x: line2X, letterSpacing: "0px !important", left: "878.5px" }}
      >
        {`as they explore `}
      </motion.p>
      <motion.p
        className="absolute  top-[519px] translate-x-[-50%]"
        style={{ opacity: line2Opacity, x: line2X, letterSpacing: "0px !important", left: "1325.5px" }}
      ...
      <motion.p
        ...
        style={{ opacity: line3Opacity, x: line3X, letterSpacing: "0px !important" }}
      >
        lines, and
      </motion.p>
      <motion.p
...
function Group7() {
  ...
  return (
    ...
    >
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[50%] not-italic text-[#6a7282] text-[20px] text-center text-nowrap top-[365px] tracking-[-0.3125px] translate-x-[-50%] whitespace-pre " style={{ fontSize: "25px" }} >
