...
function TextSid() {
  return (
    ...
    >
      <ButtonSid />
      <p className="absolute font-kaushan leading-[90px] left-[-60px] not-italic text-[#101828] text-[96px] text-nowrap top-[21.5px] tracking-[0.123px] whitespace-pre">
        Color Outside
      </p>
    </div>
  );
...
function TextSid2() {
  return (
    ...
    >
      <p className="absolute font-rubik-bubbles leading-[90px] left-0 not-italic text-[96px] text-nowrap text-white top-[1.5px] whitespace-pre">{`Primiya Arts`}</p>
    </div>
  );
}
...
function ContainerSid() {
  return (
    <div
      className="absolute content-stretch flex gap-[32px] h-[40px] items-center left-[1067px] top-[47px] w-auto"
...
export default function HeroSectionSid() {
  return (
    ...
    >
      ...
      <motion.div
        className="absolute flex h-[131.104px] items-center justify-center   w-[132.881px] "
        style={
          {
